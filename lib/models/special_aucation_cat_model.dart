...
class SpecialAucationCatModel {
  ...
  factory SpecialAucationCatModel.fromJson(Map<String, dynamic> jsonData) {
    return SpecialAucationCatModel(
      id: jsonData['id'],
