...
class MyWiningAucations extends StatefulWidget {
  @override
  _MyWiningAucationsState createState() => _MyWiningAucationsState();
}

class _MyWiningAucationsState extends State<MyWiningAucations> {
  int _filterIndex = 2;
  @override
